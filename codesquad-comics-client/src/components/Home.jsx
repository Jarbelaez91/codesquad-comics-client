...
function Home() {
    return (
      ...
      <div className="logo-container">
        <img className= "logo-image"src="./Public/images/CodeSquad-Comics-logo.png" alt="Home" />
        <nav >
          <div >
            <i className="fa-solid fa-bars hamburger-menu"></i>
        <ul className="nav-links">
          <li className="link-li" ><a href="#"> Home</a></li>
          <li className="link-li"><a href="#"> About</a></li>
          <li className="link-li"><a href="#"> Login</a></li>
        </ul>
        </div>
        </nav>
      </div>
    ...
    <p className="about-paragraph">
      CodeSquad Comics is a collection of graphic novels read by Your Jeffrey
      Arbelaez. Copyrighted images are used for review purposes only. Meta
      information about this collection can be found below. A detailed list of
      all the graphic novels in this collection can be found on the homepage.
      ...
      homepage and clicking the image of the book cover or the Details link for
      the desired graphic novel.
    </p>
</div>  
